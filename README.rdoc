...
*  http://<your adhearsion server ip>:5005/status for the number of active calls
and,  if you have Active Record in your project,  the size of your connection pool and the number of 
connections that are checked out and in use.
...
==Author
Lance Gleason  http://www.lancegleason.com/blog
